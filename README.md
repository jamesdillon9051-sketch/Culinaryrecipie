...
│       └── img/recipes/         # 2178 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 2178 image files
...
- [x] `node tools/keyword-audit.js` checks all 107,021 of them back against the
...
808 of the 1209 recipes have a photograph. Of the 1089 images on the site, 749
are CC0 or public domain, 152 are CC BY and 188 are CC BY-SA. Anything still
