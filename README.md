...
│       └── img/recipes/         # 2670 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 2670 image files
...
- [x] `node tools/keyword-audit.js` checks all 107,186 of them back against the
...
976 of the 1209 recipes have a photograph. Of the 1314 images on the site, 786
are CC0 or public domain, 253 are CC BY and 275 are CC BY-SA. Anything still
