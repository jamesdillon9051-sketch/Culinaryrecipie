...
│       └── img/recipes/         # 2614 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 2614 image files
...
- [x] `node tools/keyword-audit.js` checks all 107,181 of them back against the
...
971 of the 1209 recipes have a photograph. Of the 1307 images on the site, 784
are CC0 or public domain, 250 are CC BY and 273 are CC BY-SA. Anything still
