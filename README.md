...
│       └── img/recipes/         # 2772 image files (WebP + JPEG)
├── tools/
...
- [x] `node tools/keyword-audit.js` checks all 107,236 of them back against the
...
1029 of the 1209 recipes have a photograph. Of the 1386 images on the site, 799
are CC0 or public domain, 286 are CC BY and 301 are CC BY-SA. Anything still
