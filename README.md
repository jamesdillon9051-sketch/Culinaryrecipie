...
│       └── img/recipes/         # 2536 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 2536 image files
...
- [x] `node tools/keyword-audit.js` checks all 107,150 of them back against the
...
939 of the 1209 recipes have a photograph. Of the 1268 images on the site, 776
are CC0 or public domain, 245 are CC BY and 247 are CC BY-SA. Anything still
