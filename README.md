...
│       └── img/recipes/         # 2706 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 2706 image files
...
- [x] `node tools/keyword-audit.js` checks all 107,213 of them back against the
...
1005 of the 1209 recipes have a photograph. Of the 1353 images on the site, 797
are CC0 or public domain, 274 are CC BY and 282 are CC BY-SA. Anything still
