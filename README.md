...
│       └── img/recipes/         # 3446 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 3446 image files
...
- [x] `node tools/keyword-audit.js` checks all 125,039 of them back against the
...
1125 of the 1409 recipes have a photograph. Of the 1532 images on the site, 845
are CC0 or public domain, 329 are CC BY and 358 are CC BY-SA. Anything still
