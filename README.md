...
│       └── img/recipes/         # 2754 image files (WebP + JPEG)
├── tools/
...
├── 404.html
├── assets/                      #    css, js and 2754 image files
...
- [x] `node tools/keyword-audit.js` checks all 107,228 of them back against the
...
1021 of the 1209 recipes have a photograph. Of the 1377 images on the site, 798
are CC0 or public domain, 285 are CC BY and 294 are CC BY-SA. Anything still
