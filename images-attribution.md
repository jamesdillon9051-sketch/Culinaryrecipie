...
Every photograph on Weekly Delight is freely licensed. Of 1516
photographs, **843** are CC0 or public domain and carry no conditions at all, and
**673** are **Creative Commons Attribution (CC BY)** — free to use, adapt
...
If no properly licensed photograph could be found for a dish, the site shows
either a generated illustration, described in the next section, or a CSS
gradient placeholder carrying the recipe name. We would rather show nothing
than use an image we do not have clear rights to.
...
They are treated as a separate thing everywhere, deliberately:

- the caption under each one says it is an illustration and not a photograph
  of the dish;
- they are excluded from every photograph and licence count above;
- they are listed in their own table below rather than in the image index,
  because they have no photographer, no source archive and no licence to meet.

Each prompt was written out of the recipe's own description and ingredient
list, so it cannot describe a dish different from the one on the page. Each
result was then checked by eye against the recipe, and the ones showing the
wrong dish were deleted rather than kept.
...
|---|---|
| Recipes | 1409 |
| Hero photographs | 1114 |
| Secondary "process" photographs | 402 |
| Generated illustrations | 191 |
| Total image files | 3414 (WebP + JPEG for each) |
| Recipes using a gradient placeholder | 104 |

### Licences used

| Licence | Images | Terms |
|---|---:|---|
| CC0 | 485 | No rights reserved — no attribution legally required |
| CC BY 2.0 | 280 | Free to use, adapt and use commercially **provided the photographer is credited** |
| CC0 1.0 | 204 | No rights reserved — no attribution legally required |
| CC BY-SA 4.0 | 190 | Free to use, adapt and use commercially **provided the photographer is credited** and adaptations carry the same licence |
| Public domain | 110 | No rights reserved — no attribution legally required |
| CC BY-SA 2.0 | 97 | Free to use, adapt and use commercially **provided the photographer is credited** and adaptations carry the same licence |
| CC BY-SA 3.0 | 53 | Free to use, adapt and use commercially **provided the photographer is credited** and adaptations carry the same licence |
...
| `focaccia.webp` / `.jpg` | Rosemary Focaccia | Hero | Focaccia al rosmarino with dimples | Klism | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Focaccia_al_rosmarino_with_dimples.png) |
...
| `chicken-enchiladas.webp` / `.jpg` | Chicken Enchiladas Rojas | Hero | Chicken enchilada with rice and beans - Massachusetts | Daderot | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chicken_enchilada_with_rice_and_beans_-_Massachusetts.jpg) |
...
| `lamb-vindaloo.webp` / `.jpg` | Goan Lamb Vindaloo | Hero | Vindaloo | Miansari66 | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Vindaloo.JPG) |
...
| `masala-dosa.webp` / `.jpg` | Masala Dosa | Hero | Dosa with Chutney and Sambhar | Pravega | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Dosa_with_Chutney_and_Sambhar.jpg) |
...
| `spring-rolls.webp` / `.jpg` | Crispy Spring Rolls | Hero | GD 廣東 Guangdong 廣州 Guangzhou 荔灣區 Liwan 龍津西路 Longjin West Road shop 泮溪酒家 Pan Xi Restaurant 點心 dim sum 炸春卷 fried spring roll June 2025 R12S 01 | MeiOLA 2290 WMENSZ | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:GD_%E5%BB%A3%E6%9D%B1_Guangdong_%E5%BB%A3%E5%B7%9E_Guangzhou_%E8%8D%94%E7%81%A3%E5%8D%80_Liwan_%E9%BE%8D%E6%B4%A5%E8%A5%BF%E8%B7%AF_Longjin_West_Road_shop_%E6%B3%AE%E6%BA%AA%E9%85%92%E5%AE%B6_Pan_Xi_Restaurant_%E9%BB%9E%E5%BF%83_dim_sum_%E7%82%B8%E6%98%A5%E5%8D%B7_fried_spring_roll_June_2025_R12S_01.jpg) |
...
| `gyros.webp` / `.jpg` | Pork Gyros | Hero | Pita Gyros à Almyrida (juillet 2021) - 1 | Benoît Prieur | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pita_Gyros_%C3%A0_Almyrida_(juillet_2021)_-_1.jpg) |
...
| `brioche.webp` / `.jpg` | Brioche Loaf | Hero | Brioche-sans-oeuf-sans-beurre-vegane-vegetalienne | ElodiV | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Brioche-sans-oeuf-sans-beurre-vegane-vegetalienne.jpg) |
...
| `keema-matar.webp` / `.jpg` | Keema Matar | Hero | Spicy mutton mice with green peas | Fatimahope | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Spicy_mutton_mice_with_green_peas.jpg) |
...
| `queso-fundido.webp` / `.jpg` | Queso Fundido | Hero | Choriqueso Tacos House chorizo & cheese melt, avocado salsa, pico de gallo (25382417539) | T.Tseng | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Choriqueso_Tacos_House_chorizo_%26_cheese_melt,_avocado_salsa,_pico_de_gallo_(25382417539).jpg) |
...
| `mexican-rice.webp` / `.jpg` | Mexican Red Rice | Hero | Don Pancho's Mexican Food - May 2023 - Sarah Stierch 02 | Missvain | CC BY 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Don_Pancho%27s_Mexican_Food_-_May_2023_-_Sarah_Stierch_02.jpg) |
| `refried-beans.webp` / `.jpg` | Refried Beans | Hero | Frijoles refritos | Karyn Christner | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Frijoles_refritos.jpg) |
...
| `chicken-pot-pie.webp` / `.jpg` | Chicken Pot Pie | Hero | 2020-03-24 13 16 50 A slice of Boston Market Home Style Chicken Pot Pie after heating the Franklin Farm section of Oak Hill, Fairfax County, Virginia | Famartin | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:2020-03-24_13_16_50_A_slice_of_Boston_Market_Home_Style_Chicken_Pot_Pie_after_heating_the_Franklin_Farm_section_of_Oak_Hill,_Fairfax_County,_Virginia.jpg) |
| `chicken-pot-pie-process.webp` / `.jpg` | Chicken Pot Pie | Process | 2020-03-24 13 20 27 A slice of Boston Market Home Style Chicken Pot Pie after heating the Franklin Farm section of Oak Hill, Fairfax County, Virginia | Famartin | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:2020-03-24_13_20_27_A_slice_of_Boston_Market_Home_Style_Chicken_Pot_Pie_after_heating_the_Franklin_Farm_section_of_Oak_Hill,_Fairfax_County,_Virginia.jpg) |
...
| `onion-rings.webp` / `.jpg` | Beer-Battered Onion Rings | Hero | Beer Battered Onion Rings - RV90 - 20241107-133409 | RegionVisitor90 | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Beer_Battered_Onion_Rings_-_RV90_-_20241107-133409.jpg) |
...
| `snickerdoodles.webp` / `.jpg` | Snickerdoodles | Hero | Snickerdoodles | EvanProdromou | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Snickerdoodles.jpg) |
...
| `pecan-pie.webp` / `.jpg` | Pecan Pie | Hero | Pecan Pie on blue plate | Mshuang2 | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pecan_Pie_on_blue_plate.jpg) |
...
| `vanilla-cupcakes.webp` / `.jpg` | Vanilla Cupcakes | Hero | Perfect Vanilla Cupcakes (Unsplash) | Brooke Lark brookelark | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Perfect_Vanilla_Cupcakes_(Unsplash).jpg) |
| `chocolate-milkshake.webp` / `.jpg` | Chocolate Milkshake | Hero | Chocolate milk shake - The Bystander Cafe | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chocolate_milk_shake_-_The_Bystander_Cafe.jpg) |
| `toad-in-the-hole.webp` / `.jpg` | Toad in the Hole | Hero | Toad in the hole | Robert Gibert | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Toad_in_the_hole.jpg) |
...
| `keftedes.webp` / `.jpg` | Greek Keftedes | Hero | 20240428 meatballs with tomato sauce Restaurant Elia anagoria | Anagoria | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:20240428_meatballs_with_tomato_sauce_Restaurant_Elia_anagoria.jpg) |
...
| `fasolada.webp` / `.jpg` | Fasolada | Hero | Fasolada | Miansari66 | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Fasolada.JPG) |
...
| `mujadara.webp` / `.jpg` | Mujadara | Hero | Ailin13VeganRiceAndLentil | AilinParsa | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ailin13VeganRiceAndLentil.JPG) |
...
| `kibbeh.webp` / `.jpg` | Baked Kibbeh | Hero | Kibbe bi sanneyah | Miansari66 | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Kibbe_bi_sanneyah.JPG) |
...
| `borek.webp` / `.jpg` | Cheese Börek | Hero | Su Böreği | Maderibeyza | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Su_B%C3%B6re%C4%9Fi.JPG) |
| `borek-process.webp` / `.jpg` | Cheese Börek | Process | Cheese borek - Lily's Cafe, Brighton 2024-02-03 | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Cheese_borek_-_Lily%27s_Cafe,_Brighton_2024-02-03.jpg) |
...
| `fabada-asturiana.webp` / `.jpg` | Fabada Asturiana | Hero | Fabada | sergio.solar | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Fabada.jpg) |
...
| `pao-de-queijo.webp` / `.jpg` | Pão de Queijo | Hero | Pão de Queijo - cheese bread | Jonathan Wilkins | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:P%C3%A3o_de_Queijo_-_cheese_bread.jpg) |
...
| `poke-bowl.webp` / `.jpg` | Ahi Poke Bowl | Hero | Poke bowl 003 | Arnaud 25 | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Poke_bowl_003.jpg) |
...
| `gnocchi-alla-sorrentina.webp` / `.jpg` | Gnocchi alla Sorrentina | Hero | Gnocchi alla sorrentina. Le Scuderie, Via Simone Sancasciani 1, 56125 Pizo PI | Super nabla | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Gnocchi_alla_sorrentina._Le_Scuderie,_Via_Simone_Sancasciani_1,_56125_Pizo_PI.jpg) |
...
| `yakisoba.webp` / `.jpg` | Yakisoba | Hero | Yakisoba-Japanese-food | Boonlert Aroonpiboon | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Yakisoba-Japanese-food.jpg) |
...
| `lion-head-meatballs.webp` / `.jpg` | Lion's Head Meatballs | Hero | Lions head meatballs in brown sauce | Jpatokal | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Lions_head_meatballs_in_brown_sauce.jpg) |
...
| `hyderabadi-biryani.webp` / `.jpg` | Hyderabadi Biryani | Hero | Mutton Biryani. | Miansari66 | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Mutton_Biryani..JPG) |
...
| `cawl.webp` / `.jpg` | Welsh Cawl | Hero | Cawl in bowl | Serenpop | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Cawl_in_bowl.jpg) |
...
| `lobio.webp` / `.jpg` | Lobio | Hero | Lobio in clay pots covered with mchadi | Georgian Recipes at Georgia About | CC BY 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Lobio_in_clay_pots_covered_with_mchadi.jpg) |
| `greek-lemon-potatoes.webp` / `.jpg` | Greek Lemon Potatoes | Hero | Greek (4177990026) | Karen and Brad Emerson | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Greek_(4177990026).jpg) |
...
| `greek-yogurt-honey.webp` / `.jpg` | Greek Yoghurt with Honey and Walnuts | Hero | Flickr - cyclonebill - Græsk yoghurt med honning og valnødder | cyclonebill | CC BY-SA 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Flickr_-_cyclonebill_-_Gr%C3%A6sk_yoghurt_med_honning_og_valn%C3%B8dder.jpg) |
...
| `israeli-couscous-salad.webp` / `.jpg` | Israeli Couscous Salad | Hero | Warm winter salad (5171666531) | Karen and Brad Emerson | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Warm_winter_salad_(5171666531).jpg) |
...
| `molokhia.webp` / `.jpg` | Molokhia | Hero | ملوخية بالدجاج | Emna Mizouni | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:%D9%85%D9%84%D9%88%D8%AE%D9%8A%D8%A9_%D8%A8%D8%A7%D9%84%D8%AF%D8%AC%D8%A7%D8%AC.jpg) |
...
| `ca-kho-to.webp` / `.jpg` | Cá Kho Tộ | Hero | Cá kho tộ | Binh Giang | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:C%C3%A1_kho_t%E1%BB%99.JPG) |
...
| `popcorn-chicken-taiwanese.webp` / `.jpg` | Taiwanese Popcorn Chicken | Hero | Taiwanese Pepper Salt Chicken (鹽酥雞) in Clovis, CA | NeoBatfreak | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Taiwanese_Pepper_Salt_Chicken_(%E9%B9%BD%E9%85%A5%E9%9B%9E)_in_Clovis,_CA.jpg) |
| `popcorn-chicken-taiwanese-process.webp` / `.jpg` | Taiwanese Popcorn Chicken | Process | Taiwanese Pepper Salt Chicken Drumettes (鹽酥雞) | NeoBatfreak | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Taiwanese_Pepper_Salt_Chicken_Drumettes_(%E9%B9%BD%E9%85%A5%E9%9B%9E).jpg) |
...
| `martabak.webp` / `.jpg` | Martabak Manis | Hero | Martabak Manis Mini | Aqilla Rahmi | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Martabak_Manis_Mini.jpg) |
| `martabak-process.webp` / `.jpg` | Martabak Manis | Process | Martabak manis coklat keju khas indonesia | Malikpb | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Martabak_manis_coklat_keju_khas_indonesia.jpg) |
| `sambal-goreng.webp` / `.jpg` | Sambal Goreng Tempeh | Hero | Sambal goreng tempe | Midori | CC BY 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Sambal_goreng_tempe.JPG) |
| `nasi-lemak.webp` / `.jpg` | Nasi Lemak | Hero | Nasi Lemak | David | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Nasi_Lemak.JPG) |
| `nasi-lemak-process.webp` / `.jpg` | Nasi Lemak | Process | Nasi Lemak - Roti King 2025-09-19 | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Nasi_Lemak_-_Roti_King_2025-09-19.jpg) |
| `roti-canai.webp` / `.jpg` | Roti Canai | Hero | Roti Canai - Old Town Kopitiam Mamak AUD4 (4273370187) | Alpha from Melbourne, Australia | CC BY-SA 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Roti_Canai_-_Old_Town_Kopitiam_Mamak_AUD4_(4273370187).jpg) |
| `ayam-masak-merah.webp` / `.jpg` | Ayam Masak Merah | Hero | Ayam masak merah | Ahmad Shazlan | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ayam_masak_merah.jpg) |
| `ayam-masak-merah-process.webp` / `.jpg` | Ayam Masak Merah | Process | Spaghetti with Ayam masak merah | Phalinn Ooi's | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Spaghetti_with_Ayam_masak_merah.jpg) |
| `sinigang.webp` / `.jpg` | Sinigang na Baboy | Hero | 3615Sinigang na Hipon sa Sampalok at Tanglad 01 | Judgefloro | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:3615Sinigang_na_Hipon_sa_Sampalok_at_Tanglad_01.jpg) |
...
| `ajiaco.webp` / `.jpg` | Ajiaco | Hero | Ajiaco-santafereño | Jdvillalobos | CC BY 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ajiaco-santafere%C3%B1o.JPG) |
| `ajiaco-process.webp` / `.jpg` | Ajiaco | Process | Ajiaco santafereño 04 | ProtoplasmaKid | CC BY 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ajiaco_santafere%C3%B1o_04.jpg) |
| `empanadas-colombianas.webp` / `.jpg` | Colombian Empanadas | Hero | Colombian empanadas with ají | Huhorihe2 | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Colombian_empanadas_with_aj%C3%AD.jpg) |
| `empanadas-colombianas-process.webp` / `.jpg` | Colombian Empanadas | Process | Comida de Colombia - Empanadas | AlMo18 | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Comida_de_Colombia_-_Empanadas.jpg) |
...
| `pastel-de-choclo.webp` / `.jpg` | Pastel de Choclo | Hero | Pastel de choclo - Flickr - Marieloreto | mariela morales | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pastel_de_choclo_-_Flickr_-_Marieloreto.jpg) |
| `pastel-de-choclo-process.webp` / `.jpg` | Pastel de Choclo | Process | Pastel de Choclo (Chilean Traditional Corn Pie) | Foofine | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pastel_de_Choclo_(Chilean_Traditional_Corn_Pie).jpg) |
| `completo.webp` / `.jpg` | Completo Italiano | Hero | Completo italiano - Flickr - Bárb Santelices | Bárb Santelices. from Chile | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Completo_italiano_-_Flickr_-_B%C3%A1rb_Santelices.jpg) |
| `coxinha.webp` / `.jpg` | Coxinha | Hero | Coxinha | Tom B | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Coxinha.jpg) |
| `coxinha-process.webp` / `.jpg` | Coxinha | Process | Coxinha brasileña (hecho en Iguazú, Argentina) | Horacio Cambeiro | CC BY 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Coxinha_brasile%C3%B1a_(hecho_en_Iguaz%C3%BA,_Argentina).jpg) |
| `caipirinha.webp` / `.jpg` | Caipirinha | Hero | Caipirinha 2007 | Weetjesman | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Caipirinha_2007.JPG) |
| `rice-and-peas.webp` / `.jpg` | Rice and Peas | Hero | Rice and gungo peas Ja | Xaymacan | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Rice_and_gungo_peas_Ja.jpg) |
...
| `waakye-process.webp` / `.jpg` | Waakye | Process | Waakye in leaves | daSupremo | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Waakye_in_leaves.jpg) |
| `kelewele.webp` / `.jpg` | Kelewele | Hero | Kelewele, a Ghanaian snack | Maame1Yaa | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Kelewele,_a_Ghanaian_snack.jpg) |
| `nyama-choma.webp` / `.jpg` | Nyama Choma | Hero | Grilled goat meat, The Bali Cafe, Nairobi, 2025 (01) | Bahnfrend | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Grilled_goat_meat,_The_Bali_Cafe,_Nairobi,_2025_(01).jpg) |
| `ugali-sukuma.webp` / `.jpg` | Ugali and Sukuma Wiki | Hero | Ugali & Sukuma Wiki | Paresh Jai from Nairobi, Kenya | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ugali_%26_Sukuma_Wiki.jpg) |
| `bunny-chow.webp` / `.jpg` | Bunny Chow | Hero | Bunny Chow with Lamb & Potato - African Chow 2023-07-27 | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Bunny_Chow_with_Lamb_%26_Potato_-_African_Chow_2023-07-27.jpg) |
| `bunny-chow-process.webp` / `.jpg` | Bunny Chow | Process | Lamb Durban Curry Rice and Veg 2 Durban Curry Chow Rolls - African Chow | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Lamb_Durban_Curry_Rice_and_Veg_2_Durban_Curry_Chow_Rolls_-_African_Chow.jpg) |
| `malva-pudding.webp` / `.jpg` | Malva Pudding | Hero | Malva Pudding is a South African dessert ... - Flickr - JFGryphon | Jim Griffin | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Malva_Pudding_is_a_South_African_dessert_..._-_Flickr_-_JFGryphon.jpg) |
| `lamingtons.webp` / `.jpg` | Lamingtons | Hero | Lamingtons-2 | jules | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Lamingtons-2.jpg) |
| `lamingtons-process.webp` / `.jpg` | Lamingtons | Process | Lamingtons | jules | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Lamingtons.jpg) |
| `pavlova.webp` / `.jpg` | Pavlova | Hero | Pavlova Dessert with Fruit | Alice Batt | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pavlova_Dessert_with_Fruit.jpg) |
| `anzac-biscuits.webp` / `.jpg` | Anzac Biscuits | Hero | ANZAC biscuits (14 April 2006) | me (w:User:pfctdayelise) | CC BY-SA 2.5 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:ANZAC_biscuits_(14_April_2006).jpg) |
| `anzac-biscuits-process.webp` / `.jpg` | Anzac Biscuits | Process | Biscuit Anzac, boulangerie Les Célespains, Vichy | TCY | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Biscuit_Anzac,_boulangerie_Les_C%C3%A9lespains,_Vichy.jpg) |
| `kalua-pork.webp` / `.jpg` | Kalua Pork | Hero | MyPlate gov Cultural Food (20241025-USDA-FNS-UNK-0042) | USDAgov | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:MyPlate_gov_Cultural_Food_(20241025-USDA-FNS-UNK-0042).jpg) |
| `loco-moco.webp` / `.jpg` | Loco Moco | Hero | Loco moco 001 | Ocdp | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Loco_moco_001.jpg) |
| `loco-moco-process.webp` / `.jpg` | Loco Moco | Process | Bacon wagyu Loco Moco | Daniel Zemans | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Bacon_wagyu_Loco_Moco.jpg) |
| `breakfast-hash.webp` / `.jpg` | Breakfast Hash | Hero | Coddled Egg on hash | John Herschell | CC BY-SA 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Coddled_Egg_on_hash.jpg) |
| `ribollita.webp` / `.jpg` | Ribollita | Hero | Ribollita | Xaura | CC BY-SA 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ribollita.jpg) |
| `ribollita-process.webp` / `.jpg` | Ribollita | Process | Ribollita Siena | Ta4e Negodue | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ribollita_Siena.jpg) |
| `buddha-bowl.webp` / `.jpg` | Roasted Vegetable Buddha Bowl | Hero | BuddhaBowlLot | PizzaMan | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:BuddhaBowlLot.jpg) |
| `affogato.webp` / `.jpg` | Affogato | Hero | Affogato | VR38DETT | Public domain | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Affogato.JPG) |
| `affogato-process.webp` / `.jpg` | Affogato | Process | Affogato with Amarretti Biscotti - Tavola Di Famiglia 2026-02-27 | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Affogato_with_Amarretti_Biscotti_-_Tavola_Di_Famiglia_2026-02-27.jpg) |
| `smoothie-bowl.webp` / `.jpg` | Berry Smoothie Bowl | Hero | Acai bowl - Açaí na tigela | chahayes | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Acai_bowl_-_A%C3%A7a%C3%AD_na_tigela.jpg) |
| `smoothie-bowl-process.webp` / `.jpg` | Berry Smoothie Bowl | Process | Açaí | Gervásio Baptista/ABr | CC BY 3.0 br | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:A%C3%A7a%C3%AD.jpg) |
| `cold-brew-coffee.webp` / `.jpg` | Cold Brew Coffee | Hero | DFC 0816 A close-up of a hand holding a plastic cup while a chocolatey smoothie is poured over ice from a blender | PattayaPatrol | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:DFC_0816_A_close-up_of_a_hand_holding_a_plastic_cup_while_a_chocolatey_smoothie_is_poured_over_ice_from_a_blender.jpg) |
| `chicken-milanese.webp` / `.jpg` | Chicken Milanese | Hero | Chicken Milanese, Linguine with Snap Peas, Salad | Jeffrey_Allen | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chicken_Milanese,_Linguine_with_Snap_Peas,_Salad.jpg) |
| `pasta-puttanesca.webp` / `.jpg` | Pasta Puttanesca | Hero | Pasta Puttanesca by koishikawagirl | koishikawagirl | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pasta_Puttanesca_by_koishikawagirl.jpg) |
| `pasta-puttanesca-process.webp` / `.jpg` | Pasta Puttanesca | Process | Pasta Puttanesca | Popo le Chien | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Pasta_Puttanesca.jpg) |
| `pots-de-creme.webp` / `.jpg` | Pots de Crème | Hero | Chocolate Pot de Crème (16250666700) | Ralph Daily from Birmingham, United States | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chocolate_Pot_de_Cr%C3%A8me_(16250666700).jpg) |
...
| `shahi-paneer.webp` / `.jpg` | Shahi Paneer | Hero | Shahi Paneer with mint | Om Yadav from Land of Mt. Everest and birth place of Buddha, Nepal | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Shahi_Paneer_with_mint.jpg) |
| `shahi-paneer-process.webp` / `.jpg` | Shahi Paneer | Process | Naan shahi paneer | Realanant 1995 | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Naan_shahi_paneer.jpg) |
| `barbacoa.webp` / `.jpg` | Beef Barbacoa | Hero | Feria de la Barbacoa 7276 (46061852061) | Gobierno CDMX | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Feria_de_la_Barbacoa_7276_(46061852061).jpg) |
| `tostadas.webp` / `.jpg` | Tinga Tostadas | Hero | Tostada de tinga | Jennifer Woodard Maderazo from San Francisco, USA | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Tostada_de_tinga.jpg) |
| `tostadas-process.webp` / `.jpg` | Tinga Tostadas | Process | Tostada de tinga de pollo | Valemvglez | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Tostada_de_tinga_de_pollo.jpg) |
| `biscuits-buttermilk.webp` / `.jpg` | Buttermilk Biscuits | Hero | Buttermilk biscuits (32615978953) | terri_bateman | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Buttermilk_biscuits_(32615978953).jpg) |
| `chicken-and-waffles.webp` / `.jpg` | Chicken and Waffles | Hero | Chicken and Waffles (Unsplash) | Brooke Lark brookelark | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chicken_and_Waffles_(Unsplash).jpg) |
| `chicken-and-waffles-process.webp` / `.jpg` | Chicken and Waffles | Process | Fried Chicken & Waffles - Ed's Easy Diner 2023-09-01 | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Fried_Chicken_%26_Waffles_-_Ed%27s_Easy_Diner_2023-09-01.jpg) |
| `crab-cakes.webp` / `.jpg` | Maryland Crab Cakes | Hero | Crab Cakes (Pier Market) July 2022 | Benoît Prieur | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Crab_Cakes_(Pier_Market)_July_2022.jpg) |
...
| `chicken-rice-protein-bowl.webp` / `.jpg` | Chicken and Rice Protein Bowl | Hero | Liat Portal for Foodie Disorder - Grilled chicken with rice, potatoes and vegetables | HaJunkiyada | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Liat_Portal_for_Foodie_Disorder_-_Grilled_chicken_with_rice,_potatoes_and_vegetables.jpg) |
...
| `tofu-edamame-stir-fry-process.webp` / `.jpg` | Tofu and Edamame Stir-Fry | Process | Stir-fry spinach with tofu - Golden white jade and Green Parrot (菠菜炒豆腐 - 金鑲白玉板，紅嘴綠鸚哥)(2) | NeoBatfreak | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Stir-fry_spinach_with_tofu_-_Golden_white_jade_and_Green_Parrot_(%E8%8F%A0%E8%8F%9C%E7%82%92%E8%B1%86%E8%85%90_-_%E9%87%91%E9%91%B2%E7%99%BD%E7%8E%89%E6%9D%BF%EF%BC%8C%E7%B4%85%E5%98%B4%E7%B6%A0%E9%B8%9A%E5%93%A5)(2).jpg) |
...
| `baked-eggs-spinach-feta.webp` / `.jpg` | Baked Eggs with Spinach and Feta | Hero | Liat Portal for Foodie Disorder - Green Shakshuka with Challah and Orange Juice | HaJunkiyada | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Liat_Portal_for_Foodie_Disorder_-_Green_Shakshuka_with_Challah_and_Orange_Juice.jpg) |
...
| `salep.webp` / `.jpg` | Salep | Hero | Sahlep, a winter drink from Turkey | E4024 | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Sahlep,_a_winter_drink_from_Turkey.jpg) |
...
| `aeggekage.webp` / `.jpg` | Æggekage | Hero | 3 Rookery farm's organic eggs omelettes (salmon) - Mange Tout | Andy Li | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:3_Rookery_farm%27s_organic_eggs_omelettes_(salmon)_-_Mange_Tout.jpg) |
...
| `curtido.webp` / `.jpg` | Curtido | Hero | Curtido (6292106013) | The DLC from kansas city, mo | CC BY-SA 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Curtido_(6292106013).jpg) |
| `mechouia-salad.webp` / `.jpg` | Salade Méchouia | Hero | SaladeMechouia 2013 | Citizen59 | CC BY 3.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:SaladeMechouia_2013.JPG) |
...
| `hot-toddy.webp` / `.jpg` | Hot Toddy | Hero | A 'Hot Scotty' hot whisky toddy in an Irish coffee glass with two slices of lemon studded with cloves floating on top. Highlander Bar, Highlander Lane, Melbourne, Victoria, Australia | David Jackmanson | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/58301516@N00/40581209941) |
...
| `egg-bites.webp` / `.jpg` | Bacon and Cheddar Egg Bites | Hero | sous vide egg bites | sousvideguy | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/140547216@N04/40685260510) |
...
| `cauliflower-steaks.webp` / `.jpg` | Roasted Cauliflower Steaks | Hero | Cauliflower steak and broccoli | daveynin | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/44124370018@N01/51286800798) |
| `kale-caesar.webp` / `.jpg` | Kale Caesar Salad | Hero | Kale Caesar Salad | L.A. Foodie | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/67839741@N06/14472460957) |
| `kale-caesar-process.webp` / `.jpg` | Kale Caesar Salad | Process | Baby kale caesar salad, red caesar dressing, parmesan cheese, pickled hearts of palm, croutons | T.Tseng | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/68147320@N02/14999493247) |
...
| `moroccan-carrot-salad.webp` / `.jpg` | Moroccan Carrot Salad | Hero | Moroccan carrot salad | The Boreka Diary | CC BY-SA 2.0 | [Flickr](https://www.flickr.com/photos/41900281@N07/4810307334) |
...
| `italian-chopped-salad.webp` / `.jpg` | Italian Chopped Salad | Hero | Italian Chopped Salad | cheeseslave | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/19359283@N00/5960000060) |
...
| `halloumi-wrap.webp` / `.jpg` | Grilled Halloumi Wrap | Hero | Grilled halloumi wrap by Charly | deborah's perspective | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/38911919@N00/49930076681) |
...
| `stoemp.webp` / `.jpg` | Stoemp | Hero | Carbonnade flamande accompagnée de stoemp | avlxyz | CC BY-SA 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Carbonnade_flamande_accompagn%C3%A9e_de_stoemp.jpg) |
...
| `mushroom-stroganoff.webp` / `.jpg` | Mushroom Stroganoff | Hero | mushroom stroganoff at noodles & co in crystal city | rhettigan | CC BY 2.0 | [Flickr](https://www.flickr.com/photos/33990010@N02/4784227049) |
| `aubergine-parmigiana.webp` / `.jpg` | Griddled Aubergine Parmigiana | Hero | Melanzane alla Parmigiana | Flickr.com user "Blue Lotus" | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Melanzane_alla_Parmigiana.jpg) |
| `jackfruit-tacos.webp` / `.jpg` | Pulled Jackfruit Tacos | Hero | Picking up lunch (pulled jackfruit sandwich) at The Oxbow | Dana L. Brown | CC BY-SA 2.0 | [Flickr](https://www.flickr.com/photos/13612227@N02/50178960556) |
...
| `choucroute-process.webp` / `.jpg` | Choucroute Garnie | Process | Chicken sausage, sauerkraut, and fried potatoes - Massachusetts | Daderot | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Chicken_sausage,_sauerkraut,_and_fried_potatoes_-_Massachusetts.jpg) |
...
| `palmiers.webp` / `.jpg` | Palmiers | Hero | Palmeras de hojaldre 1 (image of palmier on Wikidata Q2096475) | jytyl | CC BY 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Palmeras_de_hojaldre_1.jpg) |
| `palmiers-process.webp` / `.jpg` | Palmiers | Process | Genji Pie | 毒島みるく | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Genji_Pie.jpg) |
...
| `bagna-cauda.webp` / `.jpg` | Bagna Cauda | Hero | Bagna càuda dip (image of bagna càuda on Wikidata Q799938) | Masaaki Komori from Tokyo, JAPAN | CC BY-SA 2.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Bagna_c%C3%A0uda_dip.jpg) |
...
| `devilled-kidneys.webp` / `.jpg` | Devilled Kidneys | Hero | devilling some kidneys | rjw1 | CC BY-SA 2.0 | [Flickr](https://www.flickr.com/photos/48524258@N00/48031195046) |
...
| `watercress-soup-process.webp` / `.jpg` | Watercress Soup | Process | Aunty Lee Geok's Farfelle with Seafood and Chicken Bolognese Sauces, Fennel Apple Salad, and Watercress Soup | avlxyz | CC BY-SA 2.0 | [Flickr](https://www.flickr.com/photos/10559879@N00/131286703) |
...
| `hokkien-mee.webp` / `.jpg` | Hokkien Mee | Hero | Newton HokkienMee (image of Hokkien mee on Wikidata Q1624233) | Jpatokal | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Newton_HokkienMee.JPG) |
| `ghoriba.webp` / `.jpg` | Ghoriba | Hero | Ghribia (image of ghraiba on Wikidata Q3104931) | Waran18 | CC BY-SA 4.0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ghribia.jpg) |
| `ghoriba-process.webp` / `.jpg` | Ghoriba | Process | تحضير حلوى الغريبة البهلة | AdilElouarti | CC0 | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:%D8%AA%D8%AD%D8%B6%D9%8A%D8%B1_%D8%AD%D9%84%D9%88%D9%89_%D8%A7%D9%84%D8%BA%D8%B1%D9%8A%D8%A8%D8%A9_%D8%A7%D9%84%D8%A8%D9%87%D9%84%D8%A9.jpg) |
