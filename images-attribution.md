...
| Total image files | 984 (WebP + JPEG for each) |
| Recipes using a gradient placeholder | 51 |
...
| CC0 1.0 | 183 | No rights reserved — no attribution legally required |
| Public Domain Mark 1.0 | 35 | Public domain — no rights reserved |
