...
module.exports = [
  ...
  /* ------------------------------------------------------------ Welsh (2) */
  c('cawl', 'Welsh Cawl', 'Welsh', 'Dinner', 'Easy', 25, 120, 6, 4.6, 622, ['Gluten-Free'], [], 'Welsh lamb and leek broth bowl'),
  ...
  /* --------------------------------------------------- International (10) */
  c('breakfast-hash', 'Breakfast Hash', 'International', 'Breakfast', 'Easy', 15, 30, 4, 4.7, 2288, ['Vegetarian', 'Gluten-Free'], ['trending'], 'Potato hash fried egg skillet'),
