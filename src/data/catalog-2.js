/**
 * CulinaryVault — recipe catalog, volume two.
 *
...
module.exports = [
  ...
  c('saltimbocca-alla-romana', 'Saltimbocca alla Romana', 'Italian', 'Dinner', 'Easy', 10, 12, 4, 4.7, 1044, ['Gluten-Free'], [], 'Saltimbocca'),
  ...
  c('sole-meuniere', 'Sole Meunière', 'French', 'Dinner', 'Easy', 10, 10, 2, 4.7, 1122, ['Gluten-Free'], [], 'Sole meuniere'),
  ...
  c('chawanmushi', 'Chawanmushi', 'Japanese', 'Appetizers', 'Medium', 15, 20, 4, 4.6, 744, ['Gluten-Free', 'Dairy-Free'], [], 'Chawanmushi'),
  c('tamagoyaki', 'Tamagoyaki', 'Japanese', 'Breakfast', 'Medium', 5, 10, 2, 4.7, 1533, ['Gluten-Free', 'Dairy-Free', 'Low-Carb'], [], 'Tamagoyaki'),
  ...
  c('char-siu-bao', 'Char Siu Bao', 'Chinese', 'Appetizers', 'Medium', 60, 20, 8, 4.7, 1622, ['Dairy-Free'], [], 'Char siu bao'),
  ...
  c('chilaquiles', 'Chilaquiles Verdes', 'Mexican', 'Breakfast', 'Easy', 15, 20, 4, 4.8, 2688, ['Vegetarian'], ['trending'], 'Chilaquiles'),
  ...
  c('queso-fundido', 'Queso Fundido', 'Mexican', 'Appetizers', 'Easy', 10, 15, 6, 4.7, 1622, ['Vegetarian', 'Gluten-Free'], [], 'Melted cheese skillet chorizo tortillas'),
  c('sopes', 'Sopes', 'Mexican', 'Appetizers', 'Medium', 30, 20, 8, 4.6, 966, ['Vegetarian'], [], 'Sopes mexican'),
  c('mexican-rice', 'Mexican Red Rice', 'Mexican', 'Quick Meals', 'Easy', 10, 25, 6, 4.7, 2133, ['Vegan', 'Gluten-Free', 'Dairy-Free'], [], 'Arroz rojo mexicano plate'),
  ...
  c('lamb-mandi', 'Lamb Mandi', 'Middle Eastern', 'Holiday Specials', 'Medium', 30, 180, 8, 4.7, 966, ['Gluten-Free', 'Dairy-Free'], [], 'Mandi rice lamb'),
  ...
  c('larb-gai', 'Larb Gai', 'Thai', 'Healthy', 'Easy', 15, 12, 4, 4.7, 1466, ['Gluten-Free', 'Dairy-Free', 'Low-Carb'], [], 'Larb gai'),
  ...
  c('gado-gado', 'Gado-Gado', 'Indonesian', 'Healthy', 'Easy', 25, 15, 4, 4.6, 1122, ['Vegan', 'Gluten-Free', 'Dairy-Free'], [], 'Gado gado'),
  ...
  c('chicken-adobo', 'Chicken Adobo', 'Filipino', 'Dinner', 'Easy', 15, 45, 4, 4.8, 2544, ['Gluten-Free', 'Dairy-Free'], ['trending'], 'Chicken adobo'),

  /* ---------------------------------------------------- Latin America (8) */
  c('arepas', 'Arepas', 'Venezuelan', 'Breakfast', 'Easy', 15, 20, 6, 4.7, 1877, ['Vegetarian', 'Gluten-Free'], [], 'Arepas'),
  c('pupusas', 'Pupusas', 'Salvadoran', 'Lunch', 'Medium', 25, 20, 6, 4.7, 1344, ['Vegetarian', 'Gluten-Free'], [], 'Pupusas'),
  c('chimichurri-steak', 'Chimichurri Steak', 'Argentinian', 'Dinner', 'Easy', 15, 15, 4, 4.8, 2688, ['Gluten-Free', 'Dairy-Free', 'Low-Carb'], ['trending'], 'Chimichurri steak'),
  ...
  c('gravlax', 'Gravlax', 'Swedish', 'Appetizers', 'Easy', 20, 0, 8, 4.7, 1122, ['Gluten-Free', 'Dairy-Free', 'Keto'], [], 'Gravlax'),
  c('kanelbullar', 'Kanelbullar', 'Swedish', 'Baking', 'Medium', 40, 15, 12, 4.8, 2133, ['Vegetarian'], ['trending'], 'Kanelbullar cinnamon buns'),

  /* --------------------------------------------- Africa & Caribbean (8) */
  c('jollof-rice', 'Jollof Rice', 'Nigerian', 'Dinner', 'Easy', 20, 50, 6, 4.9, 3411, ['Vegan', 'Gluten-Free', 'Dairy-Free'], ['editors', 'trending'], 'Jollof rice'),
  ...
  c('poke-bowl', 'Ahi Poke Bowl', 'International', 'Healthy', 'Easy', 20, 0, 2, 4.8, 2544, ['Gluten-Free', 'Dairy-Free'], ['trending'], 'Poke bowl raw tuna rice'),
  ...
  c('quinoa-salad', 'Lemon Herb Quinoa Salad', 'International', 'Healthy', 'Easy', 15, 15, 4, 4.7, 1877, ['Vegan', 'Gluten-Free', 'Dairy-Free'], [], 'Quinoa salad'),
